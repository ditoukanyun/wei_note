...
- 时间: 2026/6/23 09:06:02 CST
- 入口命令: `npx newsnow`
- 裸命令结果: 返回 CLI 用法说明，不直接输出新闻。
- `npx newsnow list --json --pretty` 结果: 共识别 66 个 source。
- 本轮结果: 50 个成功返回、4 个空结果、0 个无效 JSON、6 个非零失败、6 个超时。
- 本轮变化: `iqiyi-hot-ranklist` 与 `kaopu` 今日恢复可用，成功源比 2026-06-22 多 2 个，继续保持“失败跳过、不缩源”的覆盖策略。
...
- 科技/开发者: `ithome`、`juejin`、`github`、`github-trending-today`、`solidot`、`sspai`、`ghxi`、`pcbeta-windows`、`pcbeta-windows11`、`nowcoder`、`kaopu`
- 平台/社区热度: `bilibili`、`bilibili-hot-search`、`bilibili-hot-video`、`bilibili-ranking`、`douyin`、`douban`、`tieba`、`kuaishou`、`qqvideo-tv-hotsearch`、`hupu`、`steam`、`coolapk`、`smzdm`、`chongbuluo`、`chongbuluo-hot`、`chongbuluo-latest`
- 其余成功源: `iqiyi-hot-ranklist`
...
- 详细结果见 `50_资源/Newsletters/2026-06/原始数据/2026-06-23_newsnow-summary.json`。
