...
![单线程与多线程](40_知识库/前端开发/browser/img/28.png)
...
![多线程共享数据](40_知识库/前端开发/browser/img/29.png)
...
![浏览器单进程架构](40_知识库/前端开发/browser/img/30.png)
...
![浏览器多进程架构](40_知识库/前端开发/browser/img/31.png)
...
![目前浏览器多进程架构](40_知识库/前端开发/browser/img/32.png)
...
![未来面向服务架构](40_知识库/前端开发/browser/img/33.png)

### 弹性架构

为了在资源受限的设备上能够正常的运行浏览器，Chrome提供了弹性架构

![弹性架构](40_知识库/前端开发/browser/img/34.png)
...
![浏览器任务管理器](40_知识库/前端开发/browser/img/35.png)

根据不同浏览器以及不同版本将会显示不同的初始进程，这里以Chrome Canary为例

![任务管理器](40_知识库/前端开发/browser/img/36.png)
...
![渲染流水线](40_知识库/前端开发/browser/img/37.png)
...
![DOM树的构建过程](40_知识库/前端开发/browser/img/38.png)

在开发者工具中选中"Elements"可以看到以下HTML文档结构

![Elements](40_知识库/前端开发/browser/img/39.png)
...
![Elements css](40_知识库/前端开发/browser/img/40.png)
...
![styleSheets](40_知识库/前端开发/browser/img/41.png)
...
![css值转换](40_知识库/前端开发/browser/img/42.png)
...
![布局树](40_知识库/前端开发/browser/img/46.png)
...
![图层栏](40_知识库/前端开发/browser/img/47.png)

在这里我们可以通过调节来查看页面图层情况

![图层](40_知识库/前端开发/browser/img/48.png)
...
![绘制列表](40_知识库/前端开发/browser/img/49.png)

其中绘制指令包含绘制的具体信息，包括页面坐标、样式、背景等

![绘制指令查看](40_知识库/前端开发/browser/img/50.png)

查看具体图层的信息，点击"Paint Profile"来查看这个图层的具体绘制指令列表

![绘制指令](40_知识库/前端开发/browser/img/51.png)
...
![栅格化](40_知识库/前端开发/browser/img/52.png)

生成位图的任务由栅格化来完成，而图块是栅格化任务执行的最小单位，渲染进程维护了一个栅格化的线程池，所有的图块栅格化都是在线程池内执行的

![快速栅格化](40_知识库/前端开发/browser/img/53.png)
...
![合成显示](40_知识库/前端开发/browser/img/54.png)
