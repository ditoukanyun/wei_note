...
![斐波那契数列](40_知识库/前端开发/algorithm/img/7.png)

## 经典动态规划题

![动态规划题型1](40_知识库/前端开发/algorithm/img/5.png)
...
![动态规划分析1](40_知识库/前端开发/algorithm/img/2.png)
...
![动态规划分析2](40_知识库/前端开发/algorithm/img/3.png)

自下而上分析，从成子问题开始归纳，得出最终结果

![动态规划分析3](40_知识库/前端开发/algorithm/img/4.png)
...
最长递增子序列可定义 `dp[i]` 为以第 i 个数结尾的最长长度，再枚举前面比它小的元素更新状态。

## 常见误区

- 状态定义不清，直接套模板。
- 没处理边界，数组越界或初值错误。
- 可以贪心解决的问题强行 DP，复杂度过高。
