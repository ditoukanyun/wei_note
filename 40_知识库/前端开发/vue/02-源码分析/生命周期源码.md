...
![beforeCreate](40_知识库/前端开发/vue/img/35.png)
...
![created](40_知识库/前端开发/vue/img/36.png)
...
![beforeMount](40_知识库/前端开发/vue/img/37.png)
...
![mounted](40_知识库/前端开发/vue/img/38.png)
...
![beforeUpdate](40_知识库/前端开发/vue/img/39.png)
...
![updated](40_知识库/前端开发/vue/img/40.png)
...
![beforeDestroy](40_知识库/前端开发/vue/img/41.png)
...
![destroyed](40_知识库/前端开发/vue/img/42.png)
...
![destroyed](40_知识库/前端开发/vue/img/43.png)

## 全过程

![all](40_知识库/前端开发/vue/img/44.png)

## 生命周期流程图

```mermaid
flowchart TD
    A["new Vue"] --> B["beforeCreate / created"]
    B --> C["beforeMount / mounted"]
    C --> D["数据变化"]
    D --> E["beforeUpdate / updated"]
    E --> D
    C --> F["beforeDestroy / destroyed"]
```

## 实践检查清单

- created 和 mounted 分别适合处理哪些初始化逻辑。
- 是否避免在 beforeCreate 访问未初始化的数据和方法。
- DOM 相关操作是否放在 mounted 或 nextTick 后。
- 更新钩子中是否避免修改依赖造成重复更新。
- 销毁阶段是否解除事件、定时器和外部订阅。
