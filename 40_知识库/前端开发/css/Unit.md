...
![rem](40_知识库/前端开发/css/img/52.png)
...
![dpi](40_知识库/前端开发/css/img/48.png)
...
![ppi](40_知识库/前端开发/css/img/50.png)

接下来通过一个数据来验证公式

![ppi计算](40_知识库/前端开发/css/img/51.png)
