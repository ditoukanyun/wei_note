...
![BFC清除浮动](40_知识库/前端开发/css/img/11.png)
...
![BFC清除浮动1](40_知识库/前端开发/css/img/12.png)
...
![BFC外边距塌陷](40_知识库/前端开发/css/img/13.png)
...
![BFC外边距塌陷1](40_知识库/前端开发/css/img/14.png)
...
![BFC外边距塌陷2](40_知识库/前端开发/css/img/15.png)
...
掘金文章《史上最全面、最透彻的BFC原理剖析》强调 BFC 是一个独立渲染区域，内部块级盒子按 BFC 规则布局，和外部布局相互隔离。它的工程价值主要有三类：避免同一 BFC 内的垂直 margin 折叠影响布局；让父容器计算高度时包含内部浮动元素；让普通块不与外部浮动区域重叠，从而实现自适应两栏布局。

实践上，`display: flow-root` 比 `overflow: hidden` 更像“只为了创建 BFC”的表达，避免因为隐藏溢出导致阴影、下拉菜单或焦点轮廓被裁剪。老项目中常见的 `overflow: hidden` 清浮动可以保留，但新组件更建议显式表达布局意图。

来源：[史上最全面、最透彻的BFC原理剖析](https://juejin.cn/post/6844903496970420237)

![BFC外边距塌陷3](40_知识库/前端开发/css/img/16.png)
...
![BFC浮动元素](40_知识库/前端开发/css/img/9.png)
...
![BFC浮动元素1](40_知识库/前端开发/css/img/10.png)
...
![BFC自适应左右布局](40_知识库/前端开发/css/img/17.png)
...
![BFC自适应左右布局1](40_知识库/前端开发/css/img/18.png)

亦或者是这样

![BFC自适应左右布局2](40_知识库/前端开发/css/img/19.png)
...
![清除浮动前](40_知识库/前端开发/css/img/25.png)
...
![清除浮动后](40_知识库/前端开发/css/img/22.png)
...
![清除浮动后1](40_知识库/前端开发/css/img/23.png)
...
![清除浮动后2](40_知识库/前端开发/css/img/24.png)
