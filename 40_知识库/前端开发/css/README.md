...
- css更佳偏向于设计，也许网站的设计不是由前端决定，但是在某些时候需要前端完成
...
|------|------|
| 基础入门 | [[CSS]]、[[Unit]] |
| 布局进阶 | [[Layout]]、[[BFC]]、[[Center]] |
| 工具框架 | [[Sass]]、[[Bootstrap]]、[[Compatible]] |
...
CSS 在项目里不只是“把页面变好看”，还承担布局稳定性、响应式适配、可访问性状态、主题变量和组件边界。实际开发中应优先明确设计稿约束，再选择 Flex/Grid、BFC、定位、媒体查询或设计系统变量，避免用临时样式堆出不可维护页面。

## 检查清单

- 是否理解盒模型、层叠、继承和优先级。
- 是否能用 Flex/Grid 处理常见布局。
- 是否考虑移动端、深色模式和不同浏览器兼容。
- 是否避免全局样式污染组件。
- 是否能通过 DevTools 定位样式来源和渲染问题。
