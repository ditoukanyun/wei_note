...
![单列布局等宽](40_知识库/前端开发/css/img/26.png)
...
![单列布局通栏](40_知识库/前端开发/css/img/27.png)
...
![双列定位布局](40_知识库/前端开发/css/img/28.png)
...
![双列浮动BFC自适应布局](40_知识库/前端开发/css/img/29.png)
...
![双列flex自适应布局](40_知识库/前端开发/css/img/30.png)
...
![双列grid自适应布局](40_知识库/前端开发/css/img/31.png)
...
![双列浮动定宽布局](40_知识库/前端开发/css/img/32.png)
...
![三列浮动布局](40_知识库/前端开发/css/img/33.png)
...
![三列圣杯布局](40_知识库/前端开发/css/img/34.png)
...
![圣杯布局分析](40_知识库/前端开发/css/img/35.png)

这是未使用负边距时的布局情况，接下来使用负边距看看效果

![圣杯布局分析1](40_知识库/前端开发/css/img/36.png)

这是`margin-left:-100px`的效果，看看对比图

![圣杯布局分析2](40_知识库/前端开发/css/img/37.png)
...
![圣杯布局](40_知识库/前端开发/css/img/38.png)
...
![圣杯布局缺点](40_知识库/前端开发/css/img/39.png)
...
![圣杯布局缺点1](40_知识库/前端开发/css/img/40.png)
...
![三列双飞翼布局](40_知识库/前端开发/css/img/41.png)
...
![三列flex布局](40_知识库/前端开发/css/img/42.png)
...
![flex兼容性](40_知识库/前端开发/css/img/43.png)

grid兼容性

![grid兼容性](40_知识库/前端开发/css/img/44.png)
...
![等高效果](40_知识库/前端开发/css/img/45.png)
...
![伪等高](40_知识库/前端开发/css/img/46.png)
...
- 页面主结构是否先确定信息层级，再写样式。
- 一维排列是否优先考虑 Flex，二维网格是否优先考虑 Grid。
- 是否避免为了布局大量使用浮动和绝对定位。
- 固定栏、滚动区和自适应区域是否有明确尺寸约束。
- 移动端断点下布局是否重新组织，而不只是等比缩小。

## 案例

后台页面常见结构是顶部栏、侧边栏和内容区，可以用 Grid 定义整体骨架，用 Flex 处理工具栏按钮排列。内容区内部表格应有独立滚动边界，避免整页滚动和局部滚动互相干扰。
