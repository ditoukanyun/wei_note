...
![margin与定位对齐](40_知识库/前端开发/css/img/2.png)

上图为left与right时margin的自动填充，橘黄色位置即为margin，可以看到填充了很多。接下来我调整一下lefr与right的值

![margin与定位对齐1](40_知识库/前端开发/css/img/3.png)
...
![文字垂直居中](40_知识库/前端开发/css/img/6.png)
...
![文字垂直居中1](40_知识库/前端开发/css/img/7.png)
...
![文字垂直居中2](40_知识库/前端开发/css/img/8.png)
