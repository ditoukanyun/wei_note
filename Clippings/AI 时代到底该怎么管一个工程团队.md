...
![图像](https://pbs.twimg.com/media/HIGRub8WcAEDWfI?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGRxWJWkAAMR5D?format=jpg&name=large)

视频原链接：[https://www.youtube.com/watch?v=igO8iyca2\_g](https://www.youtube.com/watch?v=igO8iyca2_g)

![图像](https://pbs.twimg.com/media/HIGR0OEXoAAKzcd?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGR22lWEAAwx2V?format=jpg&name=large)
...
> 过去管用的老经验，现在未必行得通了。 （“What served you prior may not serve you any longer.”）过去管用的老经验，现在未必行得通了。 （“What served you prior may not serve you any longer.”）

她在演讲里反复回到这一句。多年来工程节奏围绕一个假设搭建：写代码贵、写测试贵、重构贵。从瀑布到敏捷，每一种方法论都是在分配这块稀缺资源。

![图像](https://pbs.twimg.com/media/HIGR5b6WAAEHarn?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGR8DfW0AAgdzO?format=jpg&name=large)

## 【2】当编码不再是瓶颈，新的卡点出现在哪里

Claude Code 团队现在的瓶颈是验证、评审、跨职能协作、安全。

![图像](https://pbs.twimg.com/media/HIGR_SrWwAA-Oe_?format=jpg&name=large)

代码量提升后，她被其他工程负责人问得最多的问题是：“这些代码人怎么审得过来？”她也想知道维护成本怎么算。生成代码的成本几乎为零，但维护成本不会跟着归零。

![图像](https://pbs.twimg.com/media/HIGSCJgWwAEAca-?format=jpg&name=large)

> **注：** 演讲提到的“用 Claude Code 构建 Claude Code”是 Anthropic 公司层面的公开做法。Boris Cherny 此前在多次访谈中讲过，自己用 Claude Code 在 10 天内构建了 Cowork 这个面向非技术用户的桌面 Agent。这是工程现实，不是修辞。演讲提到的“用 Claude Code 构建 Claude Code”是 Anthropic 公司层面的公开做法。Boris Cherny 此前在多次访谈中讲过，自己用 Claude Code 在 10 天内构建了 Cowork 这个面向非技术用户的桌面 Agent。这是工程现实，不是修辞。
...
![图像](https://pbs.twimg.com/media/HIGSFEaWIAAvylW?format=jpg&name=large)

> 流程极少会自然消亡。我们习惯的做法是不断地往上叠加新流程。 （“Rarely do processes kill themselves, we tend to just layer more and more and more processes on.”）流程极少会自然消亡。我们习惯的做法是不断地往上叠加新流程。 （“Rarely do processes kill themselves, we tend to just layer more and more and more processes on.”）

她举了个痛点例子：之前在某个团队，SLA（服务级承诺）多到需要拉个大表格强制排序，工程师才能弄清楚哪条需要优先响应。她早就觉得这种过度堆砌该清理了，但真正下决心动手，还是到了 Anthropic 之后。

![图像](https://pbs.twimg.com/media/HIGSH4WWgAA9RH1?format=jpg&name=large)

![图像](https://pbs.twimg.com/media/HIGSKw3WIAABifO?format=jpg&name=large)

## 【3】少做什么：六个月路线图、设计文档、产品评审

刚加入 Claude Code 时她还在问：“不需要做六个月路线图吗？”

![图像](https://pbs.twimg.com/media/HIGSN59XEAA7xkR?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGSQzyXgAAVZGg?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGSTa8XkAAupfd?format=jpg&name=large)

> 当写代码变得轻而易举，无休止的争论就显得极其昂贵。 （“When building is cheap, arguing is expensive.”）当写代码变得轻而易举，无休止的争论就显得极其昂贵。 （“When building is cheap, arguing is expensive.”）
...
![图像](https://pbs.twimg.com/media/HIGSWZwWsAAxrKR?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGSZBLWIAA1j_x?format=jpg&name=large)

![图像](https://pbs.twimg.com/media/HIGScSFWMAAhTDJ?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGSe2aXEAAcdoF?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGShrXWUAApFML?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGSlFfWIAAa3hK?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGSoJgWUAAd-zN?format=jpg&name=large)

![图像](https://pbs.twimg.com/media/HIGSrQgXUAAvFDM?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGSuCzXIAAcbxQ?format=jpg&name=large)

招聘官最初的反应是“你疯了”，意思是没有经理愿意先做 IC。

> 我希望 Claude Code 团队的每个经理都从 IC 起步，这是我对团队的期望，不接受就早点分开。 （“This is what dogfooding on the Claude Code team's about, this is what I expect and if someone's not interested it's better for us to do earlier separation.”）我希望 Claude Code 团队的每个经理都从 IC 起步，这是我对团队的期望，不接受就早点分开。 （“This is what dogfooding on the Claude Code team's about, this is what I expect and if someone's not interested it's better for us to do earlier separation.”）

这一条对她自己也是。她的上一次 push 代码到生产环境是 2017 年，加入 Anthropic 之后才重新写起代码。她说自己在 Meta 时每年还试着提交一次 PR，但内部工具变得太快，一年学一个命令第二年就过期了。

> 现在我连 git 命令都不记得了，全靠 Claude 帮我搞定。 （“Nowadays I don't even remember git commands, I just always ask Claude to help me out with all of that.”）现在我连 git 命令都不记得了，全靠 Claude 帮我搞定。 （“Nowadays I don't even remember git commands, I just always ask Claude to help me out with all of that.”）

## 【9】从文档退位，让代码成为“唯一事实来源”

![图像](https://pbs.twimg.com/media/HIGSw4TW4AAPvhg?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HIGS0CrWkAAf4Zu?format=jpg&name=large)
...
> 我已经差不多四个月没看到一次非 Claude 辅助的提交了。 （“I don't think I've seen a non-Cloud assisted commit probably in the last four months or so.”）我已经差不多四个月没看到一次非 Claude 辅助的提交了。 （“I don't think I've seen a non-Cloud assisted commit probably in the last four months or so.”）
...
> 挑出极其折腾人、尤为啰嗦的那条工作流，重新审视一下它到底还在为谁干活。 （“Pick your noisiest workflow … is it still really serving, what's the purpose of there.”）挑出极其折腾人、尤为啰嗦的那条工作流，重新审视一下它到底还在为谁干活。 （“Pick your noisiest workflow … is it still really serving, what's the purpose of there.”）
